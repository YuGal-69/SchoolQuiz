      ...
      <div className="p-4 space-y-3">
        {poll.options.map((option, index) => (
          <button
            ...
            className={`w-full text-left flex items-center border rounded-lg p-3 transition-all ${
              selectedOption === option.id
                ? "border-indigo-600 bg-indigo-50 border-2 ring-2 ring-indigo-200"
                : "border-gray-200 bg-white" // <-- FIXED: Changed bg-gray-50 to bg-white
            } ${
              disabled
